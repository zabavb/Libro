    ...
    <div>
      <header className='header-container'>
        <div className='flex gap-[60px] items-center'>
          <div className='flex gap-5 items-center'>
            <button className='form-back' onClick={() => navigate('/admin/users')}>
      ...
      <main className='flex px-[55px] py-4 gap-16'>
        ...
        <div className='flex flex-col gap-[33px] w-[50%]'>
          ...
          <div>
            <p className='text-2xl text-[#FF642E] font-semibold'>Feedbacks ({existingUser?.feedbacksCount ?? 0} psc.)</p>
            <div>
              {existingUser &&
                ...
                existingUser.feedbacksCount === 1 ? (
                  <>
                    ...
                    <p className='font-semibold text-[#FF642E] text-[16px]'>More</p>
